...
const ContactName = ({ filters }) => {
  ...
  const filteredPeople = people.filter((person) => {
    ...
    const matchesExclude =
      !filters?.exclude ||
      !person.name?.toLowerCase().includes(filters.exclude.toLowerCase());
                  ...
                  {filteredPeople.length === 0 ? (
                    ...
                    filteredPeople.map((emp, index) => (
                      <tr key={index} className="   h-14 border-b-2">
                        ...
                        <td className="text-left w-[15rem]">
                          <div className="h-full w-[15rem] flex flex-col truncate  ">
                            <div className="flex gap-1">
                              <div className="h-full w-full flex justify-between ml-6 items-center">
                                <input
                                  type="checkbox"
                                  className="rounded border-gray-300 text-primary focus:ring-primary focus:ring-2"
                                />

                                <div className="text-xs trucate">
                                  {emp.name}
                                </div>
                                <div>
                                  <a
                                  ...
                                  >
                                    <svg
                                      ...
                                      xmlns="http://www.w3.org/2000/svg"
                                    >
                                      <g clipPath="url(#clip0_2300_4290)">
                                        <path
                            ...
                            <div className="text-xs text-slate-500 text-center truncate ml-6">
                              {emp.jobtitle}
                            </div>
                          </div>
                        </td>
                        ...
                        <td>
                          <div className="w-[20rem] flex gap-2">
                            <div className="relative inline-block">
                              <button
                                // onClick={() => handleRevealAll(emp)}
                                className="bg-primary bg-purple-500 text-white text-xs w-20 h-8 rounded-md hover:opacity-90 flex items-center justify-center"
                              >
                                <span>Reveal All</span>
                              </button>
                            </div>
                            <div className="relative flex items-center">
                              <div className="border-2 w-20 rounded-md h-8 flex items-center cursor-pointer">
                                <div className="border-r w-1/2 h-full flex items-center justify-center relative text-gray-900">
                                ...
                                <div className="border-l w-1/2 h-full flex items-center justify-center relative text-gray-900">
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 24 24"
                        ...
                        <td>
                          <div className="h-full w-[15rem] flex gap-1 truncate  items-center mr-8">
