...
const CompanyName = () => {
  ...
  const handleRevealAll = (data) => {
    setEmpData(data.phone);
  };
  // const handleSearch = () => {
  //   const { companyName, contactName, jobTitle } = searchFilter;
  //   const results = empData.filter((emp) => {
  //     return (
  //       (companyName.trim() === "" ||
  //         emp.company.toLowerCase().include(companyName.toLowerCase())) &&
  //       (contactName.trim() === "" ||
  //         emp.name.toLowerCase().include(contactName.toLowerCase())) &&
  //       (jobTitle.trim() === "" ||
  //         emp.jobTitle.toLowerCase().include(jobTitle.toLowerCase()))
  //     );
  //   });
          ...
          <div className="h-full w-full bg-white rounded-md flex flex-col">
            <div className="flex h-14 w-full items-center justify-between pr-4">
              <div className="flex items-center justify-between">
                ...
                <div>
                  <p class="text-sm mr-4 font-medium"> Contacts</p>
                </div>
              </div>
