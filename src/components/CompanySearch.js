    ...
    <>
      ...
      <div className="flex items-center w-full">
          ...
          <ul className="bg-purple-200 w-60 space-y-2">
            <li className="w-60 h-14 bg-gray-50 rounded-xl flex gap-1 items-center justify-between  ">
              <svg
                ...
                stroke="currentColor"
                aria-hidden="true"
                className="ml-2 h-5 w-5 text-gray-700 hover:cursor-w-resize"
              >
                <path
              ...
              <button
                ...
                className="p-1 bg-purple-500 shadow-lg hover: shadow-2xl shadow/back border-2 border-white  text-white  rounded-md w-20 m-1 "
              >
                Search
              </button>
            </li>
            ...
            <li
              className="bg-purple-200 p-2 hover:bg-purple-100 rounded-xl space-y-1 flex flex-col"
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-black font-medium pl-1 mr-24">
                  CompanyName
                </span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li
              className="bg-gray-100 p-2 hover:bg-gray-500 rounded-xl space-y-1 flex flex-col shadow-lg"
            ...
            >
              <div className="flex items-center justify-between w-full ">
                ...
                <span className="text-xs text-black font-medium pl-1 mr-28 ">
                  Industry
                </span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li
              className="bg-gray-100 p-2 hover:bg-gray-500 rounded-xl space-y-1 flex flex-col"
            ...
            >
              <div className="flex items-center justify-between w-full">
                ...
                <span className="text-xs text-black font-medium pl-1 mr-20">
                  Year Founded
                </span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            >
              <div className="flex items-center justify-between w-full">
                ...
                <span className="text-xs text-black font-medium pl-1 mr-10 ">
                  Employee Head Count
                </span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li
              onClick={() => setShowDepartement(!showDepartment)}
              className="bg-gray-100 p-2 hover:bg-gray-500 rounded-xl space-y-1 flex flex-col"
            >
              <div className="flex items-center justify-between ">
                <svg
            ...
            <li
              onClick={() => setShowContactLocation(!showContactLocation)}
              className="bg-gray-100 p-2 hover:bg-gray-500 rounded-xl space-y-1 flex flex-col"
            >
              <div className="flex items-center justify-between ">
                <svg
                ...
                <span className="text-xs text-black font-medium pl-1 ml-1 mr-20">
                  Contact Location
                </span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="bg-indigo-200 h-screen p-4 w-full">
          <div className="bg-purple-300 p-4 rounded-2xl mb-1">
