      ...
      <div className="flex items-center w-full">
        <div className="bg-pink-300 w-60">
          <ul className="bg-gray-200 w-82 overflow-hidden">
            ...
            <li
              className="bg-gray-100 p-2 hover:bg-gray-200 rounded-xl space-y-1 flex flex-col shadow-lg"
            ...
            >
              ...
              {showContactName && (
                <input
                  ...
                  className="w-50 ml-4 rounded  shadow-2xl border-2 border-white"
                  value={contactName}
            ...
            <li
              ...
              className="bg-gray-100 p-2 hover:bg-gray-200 rounded-xl space-y-1 flex flex-col"
            >
              <div className="flex items-center justify-between ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              {showJobtitle && (
                <>
                  ...
                  <button
                    ...
                    onChange={(e) => setJobTitle(e.target.value)}
                    onClick={(e) => e.stopPropagation()}
                    class="flex gap-1 text-primary font-small text-purple mx-2"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
            ...
            <li
              className="bg-gray-100 p-2 hover:bg-gray-200 rounded-xl space-y-1 flex flex-col"
              onClick={() => setShowEmpHeadCount(!showEmpHeadCount)}
            >
              <div className="flex items-center justify-between w-full">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
