     ...
     <div className="bg-pink-300 w-60">
        <ul className="bg-gray-200 w-82 overflow-hidden">
            <li className="w-60 h-14 bg-gray-50 rounded-xl flex gap-1 items-center justify-between  ">
                ...
                <button className="p-1 bg-purple-400 shadow-lg hover: shadow-2xl shadow/back border-2 border-white  text-white  rounded-md w-20 m-1 ">Search</button>
            </li>

            <li className="font-aria font-bold p-1 text-aria">People</li>

            <li  className="bg-gray-100 p-2 hover:bg-gray-200 rounded-xl space-y-1 flex flex-col shadow-lg"
            ...
            <li onClick={() => setShowJobtitle(!showJobtitle)} className="bg-gray-100 p-2 hover:bg-gray-200 rounded-xl space-y-1 flex flex-col">
                ...
                <><input
                 type="text"
                  ...
                  onClick={(e)=>e.stopPropagation()}
                   ...
                   onChange={(e)=>setJobTitle(e.target.value)}
                   onClick={(e)=>e.stopPropagation()}
                    class="flex gap-1 text-primary font-small text-purple mx-2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="w-5 h-5"><path fill-rule="evenodd" d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM6.293 6.707a1 1 0 010-1.414l3-3a1 1 0 011.414 0l3 3a1 1 0 01-1.414 1.414L11 5.414V13a1 1 0 11-2 0V5.414L7.707 6.707a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg> Bulk Insert</button>
            ...
            <li onClick={() => setShowDepartement(!showDepartment)} className="bg-gray-100 p-2 hover:bg-gray-200 rounded-xl space-y-1 flex flex-col">
            ...
            <li onClick={() => setShowContactLocation(!showContactLocation)} className="bg-gray-100 p-2 hover:bg-gray-200 rounded-xl space-y-1 flex flex-col">
            ...
            <li onClick={() => setShowSeniority(!showSeniority)} className="bg-gray-100 p-2 hover:bg-gray-200 rounded-xl space-y-1 flex flex-col">
            ...
            <li onClick={() => setShowSearchType(!showSearchType)} className="bg-gray-100 p-2 hover:bg-gray-200 rounded-xl space-y-1 flex flex-col">
            ...
            <li onClick={() => setShowExclude(!showExclude)} className="bg-gray-100 p-2 hover:bg-gray-200 rounded-xl space-y-1 flex flex-col">
            ...
            <li className="bg-gray-100 p-2 hover:bg-gray-200 rounded-xl space-y-1 flex flex-col"
        ...
        <div className="bg-indigo-200 h-screen p-4 w-full">
            <div className="bg-gray-300 p-72 rounded-2xl mb-1 shadow-lg">
            {companyName.trim().length > 0 && <CompanyName />}
             {hqLocation.trim().length > 0 && <HqLocation />}
             {industry.trim().length>0 && <Industry />}
            {revenue.trim().length>0 && <Revenue />}
